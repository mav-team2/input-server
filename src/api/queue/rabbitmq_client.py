...
class RabbitClient:
    ...
    # ---------------------------------------------------------
    #
    def __init__(self, rabbit_url: str, exchange : Optional[str], service: Optional[str] = None,
    ...
    async def publish_message(self, routing_key: str, message: dict):
        ...
        # Declare an exchange.
        exchange = await self.channel.declare_exchange(self.exchange, durable=True)
